...
window.printQRLabel = function(id, donor, date, volume, qrSrc) {
  ...
  win.document.write(`<!DOCTYPE html><html><head><title>Milk Label — ${id}</title>
    ...
    <div class="label-box">
      ...
      <div class="barcode">MHMBS — DOH PHM Compliant — ${id}</div>
    </div>
...
window.printFormattedReport = async function() {
  ...
  <div class="subtitle">Generated: ${now} &nbsp;|&nbsp; System: MHMBS v1.0</div>
  ...
  <div class="footer">
    This report was generated by the MHMBS for the Makati Human Milk Bank.
